...
public class JWTFilter extends OncePerRequestFilter{
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        //esta implementação está somente validadno a integridade do token
        try {
        ...
        } catch (ExpiredJwtException | UnsupportedJwtException | MalformedJwtException | SignatureException err) {
            err.printStackTrace();
